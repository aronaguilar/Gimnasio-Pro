  ...
  return (
    <aside className="w-64 h-screen bg-slate-900 border-r border-slate-800 p-4 flex flex-col justify-between">
      ...
      <div>
        <NavLink
          to="/Login"
          className="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors text-sm border border-transparent bg-slate-800 text-slate-400 hover:text-emerald-400 hover:bg-emerald-500/10 hover:border-emerald-500/20"
        >
          <User size={20} />
          <span>Logearse</span>
        </NavLink>
